...
public class CustomerLoginActivity extends AppCompatActivity {
    private static final int DRIVER_LOGIN_ROOT_ID = R.id.customer_login_root;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.customer_login_root), (v, insets) -> {
